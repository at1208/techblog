...
const Top5Under60000  = () => {
  ...
  <div className='row justify-content-center col-md-9'>
            ...
            <p className='e3'>#Pros>
            Great performance.
            Good battery life compared to other gaming laptops.
            good cooling solution.
            #Cons>
            No SSD.
            Display brightness is not that great.
            ...
            It has 15.6 inch FHD IPS Anti-glare display ,it comes with 1TB HDD and 8 GB of ram (2666Mz),comes with dual blade fan cooling system and true bezeless display,best for a RGB light fan
            </p>
            <p className='e3'>#Pros>
            Good performance.
            Great build quality.
