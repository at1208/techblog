...
const MIUI11Detail = () => {
  return <div>
       ...
       <div className='container c21'>
              ...
              <img src='../../../blog12one.jpg' className='e1'/>
              <p className='e2'>Eligible Phones Roll Out Table –
              </p>
              <img src='../../../blog12two.jpg' className='e1'/>
              <p className='e2'>MIUI 11 Features –
              <ol>
              <li>Dark Mode</li>
              <img src='../../../blog12three.jpg' className='e1'/>
              <li>Floating Calculator</li>
              <img src='../../../blog12four.jpg' className='e1'/>
              <li> Custom Always On Display Styles</li>
              <img src='../../../blog12five.jpg' className='e1'/>
              <li>Inbuilt Computer-Level Document Viewer</li>
              <img src='../../../blog12six.jpg' className='e1'/>
              <li>To Do List</li>
              <img src='../../../blog12seven.jpg' className='e1'/>
              <li>Dynamic Video Wallpaper</li>
              <img src='../../../blog12eight.png' className='e1'/>
              <li>And Many More Features – </li>
              <img src='../../../blog12nine.jpg' className='e1'/>
              </ol>
              </p>
