...
In Dec 1949, some Hindu activists placed idols of Ram inside the disputed structure, leading to communal tension . The mosque was seized by authorities. Court orders restrained people from removing the idols, and the structure's use as a mosque effectively ceased from that point.

</p>
<p className='e2'>What did the 3 sides say in SC?</p>
 <p>
The Muslim side wants the masjid rebuilt at the same location. It also wants the SC to implement the Places of Worship Act 1991 which freezes all places of worship as they existed when India became free. This is to prevent spillovers to other disputed sites like Mathura and Kashi. The akhara and deity want possession of the land. The akhara is willing to concede the rights of the title to the deity if its shebait is recognised.
